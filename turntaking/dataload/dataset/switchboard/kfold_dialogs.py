...
from turntaking.dataload.utils import read_txt, write_txt
from turntaking.dataload.dataset.switchboard.switchboard import INCLUDES_ASIDES


KFOLD_ROOT = "dataload/dataset/switchboard/files/kfolds"
...
if __name__ == "__main__":
    ...
    test = read_txt("dataload/dataset/switchboard/files/test.txt")
